...
| --- | --- | --- |
| `/api/service-requests` | GET, POST | List (auth, role-filtered; street redacted until accept) / create (photos, street/floor, time-of-day, then match nearby daddies; `unlisted` omits from the public teaser) |
