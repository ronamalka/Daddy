      ...
      <div className="space-y-6 text-[rgb(var(--color-text-secondary))] leading-relaxed">
        <section>
          ...
          <p>
            ...
            ובהתאם לתקן הישראלי ת״י 5568 ברמת AA.
          </p>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc list-inside space-y-2 mt-2">
            <li>שינוי גודל הטקסט (הגדלה והקטנה, עד 200%)</li>
        ...
        <section>
          <h2 className="text-xl font-semibold text-[rgb(var(--color-text))] mb-3">תאריכים</h2>
          <p>תאריך ביקורת הנגישות האחרונה: אוגוסט 2026.</p>
          <p>תאריך עדכון ההצהרה: אוגוסט 2026.</p>
        </section>
      </div>
    </div>
  );
