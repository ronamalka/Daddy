...
const FAQ: { q: string; a: ReactNode }[] = [
  ...
  { q: "מה אם לא מרוצה מהשירות?", a: (
    <>
      קודם כל — דברו עם האבאל׳ה. רוב הבעיות נפתרות בשיחה (כמו בחיים). אם לא הצלחתם —{" "}
      <Link href="/orders" className="font-semibold text-[rgb(var(--color-primary))] hover:underline">פתחו מחלוקת מדף ההזמנה</Link>
      {" "}(בזמן העבודה או אחרי מסירה, עם עד 5 תמונות). צוות אבאל׳ה יבדוק ויעזור לתווך.
    </>
  ) },
  ...
  { q: "אפשר לבטל?", a: "כן — עד 24 שעות לפני חלון הביקור הביטול חינם. אחר כך נרשמים דמי ביטול לאבאל׳ה: שעת עבודה אחת או ₪50, הנמוך מביניהם (גם לפני שיש סליקה בפלטפורמה). אחרי שהעבודה התחילה אי אפשר לבטל לבד — פותחים מחלוקת מדף ההזמנה. ביקור בית במועד שנקבע אינו 14 ימי ביטול של מכר מרחוק." },
  { q: "איך אני יודע שהאבאל׳ה אמין?", a: "ביקורות ציבוריות שלא ניתנות לעריכה או מחיקה. מספר עבודות שהושלמו. אזורי שירות. בקיצור — כל מה שצריך כדי להחליט בלי לשאול את השכנה. זה לא בדיקת רישיון או ביטוח מצד אבאל׳ה — בקשו מהספק להציג אותם לפני עבודה טעונת רישיון." },
  ...
  return (
    <div className="min-h-screen bg-[rgb(var(--color-bg))]">
      ...
      <section className="mx-auto max-w-3xl px-4 py-16">
        ...
        <p className="mt-8 text-center text-[13px] text-[rgb(var(--color-text-muted))]">
          אבאל׳ה מחברת בין צדדים ואינה נותנת את השירות בשטח.{" "}
          <a href="/terms" className="font-semibold text-[rgb(var(--color-primary))] hover:underline">תנאי שימוש</a>
          {" · "}
          <a href="/guidelines" className="font-semibold text-[rgb(var(--color-primary))] hover:underline">כללי קהילה</a>
        </p>
      </section>
