...
const FAQ = [
  { q: "כמה עולה להשתמש באבאל׳ה?", a: "הרשמה ופרסום פרופיל — חינם, בלי תשלום על הצגת טלפון. על כל עבודה שנסגרת באתר הלקוח משלם דמי שירות של 17% ממחיר האבאל׳ה. האבאל׳ה מקבל את המחיר שפרסם במלואו. בקופה רואים את הפירוט לפני שמשלמים — בלי הפתעות." },
