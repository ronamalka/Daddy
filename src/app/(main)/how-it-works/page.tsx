...
const FAQ = [
  ...
  { q: "מה אם לא מרוצה מהשירות?", a: "קודם כל — דברו עם האבאל׳ה. רוב הבעיות נפתרות בשיחה (כמו בחיים). אם לא הצלחתם — פתחו מחלוקת מדף ההזמנה (בזמן העבודה או אחרי מסירה, עם עד 5 תמונות). צוות אבאל׳ה יבדוק ויעזור לתווך." },
