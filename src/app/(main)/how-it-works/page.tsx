...
const FAQ: { q: string; a: ReactNode }[] = [
  ...
  { q: "אפשר לבטל?", a: "בטח. כל עוד העבודה לא התחילה — ביטול חופשי לפי הסכמת הצדדים. אם כבר התחילה, תאמו מול האבאל׳ה. לצרכנים עשויות לחול גם זכויות לפי חוק הגנת הצרכן (למשל 14 ימי ביטול בעסקת מכר מרחוק, בכפוף לחריגים)." },
