...
const VALUES: { title: string; desc: string; Icon: PhosphorIcon }[] = [
  ...
  { title: "הוגנות", desc: "האבאל׳ה מגדיר מחיר ומקבל אותו במלואו. הלקוח רואה בקופה דמי שירות של 17% — בלי עמלות נסתרות ובלי ׳אה, שכחתי להגיד׳.", Icon: Scales },
      ...
      <section className="mx-auto max-w-3xl px-4 py-16">
        <div className="rounded-2xl border border-[rgb(var(--color-border))] bg-[rgb(var(--color-surface))] p-8 md:p-12">
          ...
          <div className="space-y-4 text-[15px] leading-relaxed text-[rgb(var(--color-text-secondary))]">
            ...
            <p>
              ככה נולד אבאל׳ה. פלטפורמה שמחברת בין אנשים עם ידיים טובות ושנים של ניסיון — לבין אנשים שפשוט צריכים שמישהו יגיד &quot;שנייה, אני בא&quot;. בלי מתווכים מיותרים, בלי הפתעות בקופה.
            </p>
          </div>
        </div>
      </section>
